...
const TRANSLATIONS = {
  ko: {
    ...
    cert_label: "실시간 수문학 시뮬레이션 기반 도로 안전도 정보 피드",
    distance: "예상 경로 총 거리",
    ...
    alert_crit_title: "🚨 기상 재난 경보: 저지대 침수 발생 및 즉시 대피 권고 🚨",
    alert_crit_msg: "강수량 및 강수위가 한계를 초과하여 저지대 침수 위험이 매우 높습니다. 지연 없이 신속하게 인근 안전 대피소로 대피해 주십시오.",
    alert_warn_title: "⚠️ 기상 경보: 강변 침수 진행에 따른 고지대 우회 권고",
    alert_warn_msg: "메콩강 수위 상승으로 강변 일부 저지대 도로가 침수되었습니다. 삼센타이 등 안내되는 안전한 고지대 포장도로로 즉시 우회하십시오.",
    alert_caut_title: "⚡ 기상 주의보: 노면 미끄러움 및 비포장 차단 우려",
    alert_caut_msg: "비포장 야시장 골목 등 침수 및 진흙 누적 예상 구간을 피하고, 포장된 안전한 간선도로로 서행하여 이동하십시오.",
    alert_norm_title: "☀️ 기상 상황: 안전하고 원활한 운행 환경",
    alert_norm_msg: "현재 기상 및 도로 상태가 양호합니다. 안전을 위해 규정 속도를 준수하고 안전 거리를 유지하며 운행하시기 바랍니다.",
